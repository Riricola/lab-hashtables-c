...
public class ChainedHashTable<K,V> implements HashTable<K,V> {
  ...
  void expand() {
    ...
    /*
     * How to fix expand:
     * when the length is doubled, the hashcode index of each pair is changed
     * so we need to iterate through each pair, call find on the pair to return
     * the new index, call set on that new index with the given pair
     */
  } // expand()
